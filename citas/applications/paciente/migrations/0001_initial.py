    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_documento', models.CharField(choices=[('0', 'Registro Civil'), ('1', 'Tarjeta Identidad'), ('2', 'Cedula Ciudadania'), ('3', 'Tarjeta Extranjeria'), ('4', 'Otro')], max_length=1, verbose_name='Tipo Documento')),
